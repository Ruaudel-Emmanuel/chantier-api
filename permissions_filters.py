...
from .models import Chantier, Membre
...
class IsChefChantier(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if hasattr(obj, 'chantier'):
            return request.user == obj.chantier.chef or request.user.is_staff
        
        if hasattr(obj, 'lot') and hasattr(obj.lot, 'chantier'):
            return request.user == obj.lot.chantier.chef or request.user.is_staff
    ...
    def has_object_permission(self, request, view, obj):
        try:
            ...
            if hasattr(obj, 'equipe'):
                return obj.equipe == membre.equipe or request.user.is_staff
...
from .models import Chantier, Tache, StatusChantier, StatusTache
