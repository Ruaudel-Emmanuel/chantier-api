...
from .models import (
    ...
    StatusChantier, StatusTache, RoleMembre, TypeSousTraitant
)
...
class TestChantierModel:
    ...
    def test_progression_chantier(self):
        ...
        tache1 = TacheFactory(lot=lot, status=StatusTache.A_FAIRE)
        tache2 = TacheFactory(lot=lot, status=StatusTache.TERMINEE)
...
class TestChantiersAPI:
    ...
    def test_creer_chantier(self, api_client_auth):
        ...
        data = {
            ...
            'date_fin_prevue': (date.today() + timedelta(days=30)).isoformat(),
...
class TestTachesAPI:
    ...
    def test_upload_photo(self, api_client_auth, tmpdir):
